...
def val_btnC():
    val.set("C")
    sound = pygame.mixer.Sound("C:\Users\aansi\Desktop\Piano_Tkinter_Python\Z_Music_Notes\Music_Notes\C.wav")
    sound.play()
    return

def val_btnD():
    val.set("D")
    sound = pygame.mixer.Sound("C:\Users\aansi\Desktop\Piano_Tkinter_Python\Z_Music_Notes\Music_Notes\D.wav")
    sound.play()
    return

def val_btnE():
    val.set("E")
    sound = pygame.mixer.Sound("C:\Users\aansi\Desktop\Piano_Tkinter_Python\Z_Music_Notes\Music_Notes\E.wav")
    sound.play()
    return

def val_btnF():
    val.set("F")
    sound = pygame.mixer.Sound("C:\Users\aansi\Desktop\Piano_Tkinter_Python\Z_Music_Notes\Music_Notes\F.wav")
    sound.play()
    return

def val_btnG():
    val.set("G")
    sound = pygame.mixer.Sound("C:\Users\aansi\Desktop\Piano_Tkinter_Python\Z_Music_Notes\Music_Notes\G.wav")
    sound.play()
    return

def val_btnA():
    val.set("A")
    sound = pygame.mixer.Sound("C:\Users\aansi\Desktop\Piano_Tkinter_Python\Z_Music_Notes\Music_Notes\A.wav")
    sound.play()
    return

def val_btnB():
    val.set("B")
    sound = pygame.mixer.Sound("C:\Users\aansi\Desktop\Piano_Tkinter_Python\Z_Music_Notes\Music_Notes\B.wav")
    sound.play()
    return

def val_btnC1():
    val.set("C1")
    sound = pygame.mixer.Sound("C:\Users\aansi\Desktop\Piano_Tkinter_Python\Z_Music_Notes\Music_Notes\C1.wav")
    sound.play()
    return

def val_btnD1():
    val.set("D1")
    sound = pygame.mixer.Sound("C:\Users\aansi\Desktop\Piano_Tkinter_Python\Z_Music_Notes\Music_Notes\D1.wav")
    sound.play()
    return

def val_btnE1():
    val.set("E1")
    sound = pygame.mixer.Sound("C:\Users\aansi\Desktop\Piano_Tkinter_Python\Z_Music_Notes\Music_Notes\E1.wav")
    sound.play()
    return

def val_btnF1():
    val.set("F1")
    sound = pygame.mixer.Sound("C:\Users\aansi\Desktop\Piano_Tkinter_Python\Z_Music_Notes\Music_Notes\F1.wav")
    sound.play()
    return
